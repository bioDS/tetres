...
#         new_cmchain = coupled_MChains(self.m_chains, self.tree_files, self.log_files, self.working_dir, name=f"{self.name}_cen")
#         new_cmchain.m_chains += new_cmchain.m_chains
...
#                                   "required!")
#
#     for chain in range(self.m_chains):
#         if chain != 0:
...
#     for i in range(1, int(cmchain.m_chains / 2) + 1):
#         clustering[-i] = i + 1
#
#     plot_coords(coords, colors=clustering, filename=f"{cmchain.working_dir}/plots/{cmchain.name}_"
#                                                     f"summaries{'_rf' if rf else ''}.png",
#                 centers=int(cmchain.m_chains / 2))
#
#
